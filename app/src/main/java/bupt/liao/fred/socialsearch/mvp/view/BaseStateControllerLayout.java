...
public class BaseStateControllerLayout extends FrameLayout {
    ...
    public BaseStateControllerLayout(Context context) {
        this(context, null);
    }

    public BaseStateControllerLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BaseStateControllerLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void setupAttrs(Context context, AttributeSet attrs) {
        ...
        errorLayoutId = typedArray.getResourceId(R.styleable.BaseStateControllerLayout_errorLayoutId, RES_NONE);
        emptyLayoutId = typedArray.getResourceId(R.styleable.BaseStateControllerLayout_emptyLayoutId, RES_NONE);
        contentLayoutId = typedArray.getResourceId(R.styleable.BaseStateControllerLayout_contentLayoutId, RES_NONE);
        typedArray.recycle();
    }
    ...
    public BaseStateControllerLayout loadingView(View loadingView) {
    ...
    public BaseStateControllerLayout errorView(View errorView) {
    ...
    public BaseStateControllerLayout emptyView(View emptyView) {
    ...
    public BaseStateControllerLayout contentView(View contentView) {
